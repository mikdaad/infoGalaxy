    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        <h3 className="ba-title">
          <span>Why Choose cashwayclicks</span>
        </h3>
        ...
        <p className="ba-checks ba-check-first">
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> Best Professional Trainers
        </p>
        <p className="ba-checks">
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> helping beginners
        </p>
        <p className="ba-checks">
